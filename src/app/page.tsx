  ...
  return (
    <main className="min-h-screen bg-black relative">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 py-14">
        {/* HERO */}
        <section id="hero" className="min-h-[65vh] flex flex-col justify-center">
        ...
        {/* BUILD */}
        <section id="build" className="glass rounded-3xl p-8 mb-8">
        ...
        {/* CONVERT */}
        <section id="convert" className="glass rounded-3xl p-8 mb-8">
