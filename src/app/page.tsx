    ...
    <main className="min-h-screen bg-black relative">
      ...
      <div className="relative z-10 snap-y-mandatory">
        <div className="mx-auto max-w-6xl px-6">
          ...
          <section
            id="hero"
            className="snap-start min-h-[100svh] flex flex-col justify-center py-14"
          >
          ...
          <section
            id="build"
            className="snap-start min-h-[100svh] flex items-center py-14"
          >
          ...
          >
            <div className="glass rounded-3xl p-8 w-full">
              ...
              <form className="mt-6 grid gap-3">
                ...
                <input className="glass rounded-2xl px-4 py-3 text-sm outline-none" placeholder="Company / Project" />
                <textarea className="glass rounded-2xl px-4 py-3 text-sm outline-none" rows={4} placeholder="What do you need?" />
                <button
                  type="button"
